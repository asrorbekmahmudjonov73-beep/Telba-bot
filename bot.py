...
BASE_URL = os.getenv("RENDER_EXTERNAL_HOSTNAME")          # Render avto beradi (masalan your-app.onrender.com)
WEBHOOK_PATH = f"/webhook/{TOKEN}"                        # xavfsizroq yo'l
...
# Sizning ovozlar ro'yxati (o'zgarmagan)
all_voices = [
...
def main():
    ...
    # Render sog'liq tekshiruvi uchun oddiy /health yo'li (majburiy emas, lekin yaxshi)
    ...
    # Render PORT ni o'qiydi (odatda 10000)
